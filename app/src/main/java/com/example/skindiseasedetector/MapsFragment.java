...
public class MapsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        searchNearby = view.findViewById(R.id.searchNearby);
        ...
        mapView.getMapboxMap().loadStyle("mapbox://styles/sdd0101/clwdu5kr100fk01rd5tmb1y0t", new Style.OnStyleLoaded() {
            @Override
